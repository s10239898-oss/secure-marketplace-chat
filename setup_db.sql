-- Clean setup script for PostgreSQL
-- Run as postgres user or with proper privileges
...
-- Grant permissions to moturi311
GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO moturi311;
GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA public TO moturi311;
